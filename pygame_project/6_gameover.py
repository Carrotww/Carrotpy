    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                # 가장 작은 크기의 공이 아니라면 다음 작은 공으로 나눠주기
                if ball_img_idx < 3:
                    # 현재 공 크기 정보를 가지고 옴
                    ball_width = ball_rect.size[0]
                    ball_height = ball_rect.size[1]

                    # 나눠진 공 정보 idx + 1을 해주는건 나눠진 공으로 바꿔주기 위함
                    ...
                    balls.append({
                        ...
                        "pos_y": ball_pos_y + ball_height / 2 - small_ball_height / 2,  # y 좌표
        ...
        break # 안쪽 for 문에서 break을 만나면 여기로 진입 가능. 2중 for 문을 한번에 탈출
