...
# 적 캐릭터
enemy = pygame.image.load("C:\\Users\\유형석\\PycharmProjects\\pythonProject\\Carrotpy\\pygame_basic\\enemy.png")
enemy_size = enemy.get_rect().size # 이미지의 크기를 구해 올 수 있음
enemy_width = enemy_size[0]
enemy_height = enemy_size[1]
enemy_x_pos = (screen_width / 2) - (enemy_width / 2) # 화면 가로의 절반 크기에 해당하는 곳에 위치함
